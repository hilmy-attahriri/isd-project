...
- **Global scope**: `/home/dipta/isd-project/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/dipta/isd-project/.codex/notes/`)
...
2. Glob `/home/dipta/isd-project/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/home/dipta/isd-project/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/dipta/isd-project/.codex/notes/` — works in any directory
