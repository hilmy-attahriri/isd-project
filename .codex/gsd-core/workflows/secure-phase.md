...
```
Agent(
  prompt="Read /home/dipta/isd-project/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/dipta/isd-project/.codex/gsd-core/templates/SECURITY.md`
