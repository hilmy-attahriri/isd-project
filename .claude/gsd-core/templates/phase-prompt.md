...
<!-- For checkpoint task examples and patterns, see @/home/dipta/isd-project/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/dipta/isd-project/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/dipta/isd-project/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/dipta/isd-project/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
