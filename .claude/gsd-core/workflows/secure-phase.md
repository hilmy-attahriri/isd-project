...
```
Agent(
  prompt="Read /home/dipta/isd-project/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/dipta/isd-project/.claude/gsd-core/templates/SECURITY.md`
