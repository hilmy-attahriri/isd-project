...
Reference full template: `/home/dipta/isd-project/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/dipta/isd-project/.claude/gsd-core/templates/state.md`.
