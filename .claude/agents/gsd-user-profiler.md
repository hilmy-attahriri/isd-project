...
<reference>
@/home/dipta/isd-project/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/dipta/isd-project/.claude/gsd-core/references/user-profiling.md` to load:
