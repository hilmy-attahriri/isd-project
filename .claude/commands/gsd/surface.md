...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/dipta/isd-project/.claude/.gsd-surface.json`
(sibling to `/home/dipta/isd-project/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/dipta/isd-project/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/dipta/isd-project/.claude/skills`).
...
`/home/dipta/isd-project/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/dipta/isd-project/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/dipta/isd-project/.claude/.gsd-surface.json`
Install profile marker: `/home/dipta/isd-project/.claude/.gsd-profile`
Skill dirs: `/home/dipta/isd-project/.claude/skills/gsd-*/`
Engine module: `/home/dipta/isd-project/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/dipta/isd-project/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
